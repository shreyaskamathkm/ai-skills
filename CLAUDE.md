# CLAUDE.md — 12-Rule AI Coding Guidelines
...
*   If two patterns or guidelines in the codebase contradict each other, do not blend or "average" them.
*   Select the most appropriate pattern (e.g., the more recent or more extensively tested one).
*   Document the choice, explain the rationale, and flag the opposing pattern for future cleanup.
